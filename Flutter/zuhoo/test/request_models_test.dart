...
void main() {
  ...
  group('SubmitReviewRequest', () {
    test('drops an empty comment rather than sending a blank one', () {
      final json = const SubmitReviewRequest(
        serviceRequestId: 4,
        rating: 5,
        comment: '   ',
      ).toJson();
    ...
    test('keeps a real comment, trimmed', () {
      final json = const SubmitReviewRequest(
        serviceRequestId: 4,
        rating: 4,
      ...
      expect(json['comment'], 'Quick and clear.');
    });
  });
}
