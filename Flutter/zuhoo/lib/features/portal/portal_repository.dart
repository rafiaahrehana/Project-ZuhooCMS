...
class PortalRepository {
  ...
  /// What a portal client may change about themselves.
  ///
  /// A deliberately narrower endpoint than the staff-side client update: it
  /// takes company details and addresses only. Their name, email and account
  /// status are not editable here — those belong to the company that owns the
  /// relationship, and a client editing their own status would be able to
  /// reopen an account the company had closed.
  Future<ClientProfile> updateProfile(UpdateMyProfileRequest request) async {
