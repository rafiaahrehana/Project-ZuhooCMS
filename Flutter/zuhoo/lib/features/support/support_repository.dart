...
class SupportRepository {
  ...
  /// Corrects a ticket's title, description or priority.
  ///
  /// Role-gated rather than permission-gated — see [ticketEditRoles] — and a
  /// replace rather than a patch, so the whole body goes every time.
  Future<SupportTicket> update(int id, UpdateTicketRequest request) async {
  ...
  /// Removes a ticket outright. Narrower roles than editing — see
  /// [ticketDeleteRoles]. 204, no body.
  Future<void> delete(int id) => _api.delete<dynamic>('$_tickets/$id');
