...
import 'create_payroll_sheet.dart';
...
class PayslipsScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final canProcess = ref
        .watch(permissionControllerProvider)
        .has(PayrollPermissions.process);

    return Scaffold(
      backgroundColor: bos.bgPage,
      appBar: AppBar(title: const Text('My payslips')),
      // The screen is a personal one, but this is the app's only payroll
      // surface, and somebody with PAYROLL_PROCESS creating a missed record is
      // a real errand. Hidden entirely without the permission, so it does not
      // read as part of the personal view for everyone else.
      floatingActionButton: canProcess
          ? FloatingActionButton.extended(
              onPressed: () => showCreatePayrollSheet(context),
