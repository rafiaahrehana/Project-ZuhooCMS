      ...
      child: Builder(
        builder: (context) {
          ...
          return AnimatedBuilder(
            ...
            builder: (context, _) {
              // The Balances tab grants an entitlement; every other tab is
              // about requests, so it applies for one.
              final onBalances =
                  tabs[tabController.index].label == 'Balances' && canGrant;
              ...
              return Scaffold(
                ...
                floatingActionButton: onBalances
                    ? FloatingActionButton.extended(
                        onPressed: () => showGrantLeaveBalanceSheet(context),
