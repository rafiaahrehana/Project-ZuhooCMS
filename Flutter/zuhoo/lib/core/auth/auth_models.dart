...
/// POST /api/auth/register. Field names and validation mirror
/// `com.zuhoocms.modules.company.RegisterRequest` exactly: password needs at
/// least one upper-case letter, one lower-case letter, one digit and one
/// special character, and subdomain is lower-case letters/digits/hyphens.
...
/// POST /api/auth/register response (backend's `UserResponse`). The account
/// exists after this but cannot sign in until the code sent by email is
/// entered on [VerifyEmailRequest] — `emailVerified` here is always false.
