...
class AuthController extends AsyncNotifier<AppUser?> {
  ...
  Future<void> _warmSession() async {
    // Covers a token that rotated while the app was closed, and a device that
    // is only gaining push support now because the app itself just updated.
  ...
  Future<void> logout() async {
    ...
    // Before the session is cleared: the endpoint needs the Authorization
    // header the current access token still provides.
